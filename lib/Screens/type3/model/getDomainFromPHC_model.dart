...
GetDomainFromPhcModel getDomainFromPhcModelFromJson(String str) => GetDomainFromPhcModel.fromJson(json.decode(str));

String getDomainFromPhcModelToJson(GetDomainFromPhcModel data) => json.encode(data.toJson());

class GetDomainFromPhcModel {
    SuccessResponse successResponse;

    GetDomainFromPhcModel({
        required this.successResponse,
    });

    factory GetDomainFromPhcModel.fromJson(Map<String, dynamic> json) => GetDomainFromPhcModel(
