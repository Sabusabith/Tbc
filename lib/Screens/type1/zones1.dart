...
import 'package:qhance_uiii/Screens/type1/controller/get_zones1_controller.dart';
import 'package:qhance_uiii/Screens/type1/phcZones1.dart';
...
class Zones1 extends StatelessWidget {
      DateTime? currentBackPressTime; // Declare currentBackPressTime variable

  GetZonesController1 controller = GetZonesController1();
                      ...
                      child: FutureBuilder<GetZoneModel>(
                        ...
                        itemBuilder: (context, index) => InkWell(
                          onTap: () async {
                            ...
                            Get.to(PhcZones1(zoneName:data.successResponse.data[index].zoneName.toString(), phcDetailList: selectedPhcDetail ,));
                          },
                          child: Container(
                            width: 200,
                            height: 200, // Fixe
