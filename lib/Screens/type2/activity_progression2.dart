...
import 'package:qhance_uiii/Screens/type2/controller/update_Activity_controller.dart';
...
class ActivityProgression2 extends StatefulWidget {
 ActivityProgression2({super.key,required this.taskid,required this.phcid,required this.taskname,required this.evidence});
var taskid ;
var phcid;
var taskname;
var evidence;
    ...
    return SafeArea(
      ...
      appBar: AppBar(
        ...
        actions: [
           GestureDetector(
            onTap: (){
              actionPlanController.getActionplans(widget.phcid);
