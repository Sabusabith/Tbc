...
class PhcZones extends StatelessWidget {
 PhcZones({required this.zoneName,required this.phcDetailList});
var zoneName;
  final List<Phc>? phcDetailList;
 GetDomainFromPHCcontroller2 ccontroller2 = Get.put(GetDomainFromPHCcontroller2());
  @override
