...
import 'controller/get_specialization_controller.dart';
import 'model/getzones_model.dart';

class AddUser extends StatefulWidget {
  AddUser({required this.phcDetailList});
...
class _AddUserState extends State<AddUser> {
  ...
  GetDomainFromPHCcontroller2  phCcontroller2 = Get.put(GetDomainFromPHCcontroller2());
